...
public class MakePayRequest {
    ...
    public PayRequest getReadyRequest(Long id, PayInfoDto payInfoDto) {
        ...
        map.add("approval_url", "http://52.78.16.255:8080/api/payment/success?id=" + id); // 성공 시 redirect url
//        map.add("approval_url", "http://localhost:3000/store?id=" + id);
        map.add("cancel_url", "http://52.78.16.255:8080/api/payment/cancel"); // 취소 시 redirect url
        map.add("fail_url", "http://52.78.16.255:8080/api/payment/fail"); // 실패 시 redirect url
